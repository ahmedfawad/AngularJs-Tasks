angular.module('twitterApp.services', []).factory('twitterService', function($q) {
    ...
    /*
    * First we will get access token on the behalf of user
    * and then authorize the requests to send to twitter
    *
    *
    * */
    ...
    return {
        initialize: function() {
            ...
            OAuth.initialize('kIM1NJVKyDPu8UNS8Tigf0hFMNA', {cache:true});
